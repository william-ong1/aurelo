    ...
    return (
      <div className="">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-white rounded-lg p-5 shadow-sm border border-slate-200 animate-pulse">
    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
        ...
        <div className="bg-white rounded-lg p-5 shadow-sm border border-slate-200">
          ...
          <div className="space-y-4">
            <div>
                                      <div className="text-xs sm:text-xl 2xl:text-2xl font-bold text-gray-900">
