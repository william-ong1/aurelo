  ...
  return (
    <div className="mt-6 sm:mt-8 rounded-lg p-4 sm:p-6 bg-gradient-to-br from-slate-50 to-slate-100 shadow-lg">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-200">Real-Time Portfolio</h2>
        <button
      ...
      {error && (
        <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-gray-600 rounded-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 sm:p-5 shadow-sm border border-gray-100 dark:border-gray-600">
